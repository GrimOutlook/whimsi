...
// This Proof of concept is just trying to match an MSI made by a custom script I made earlier.
//
// Information was gathered using the `msitools` package that we are trying to replace :p
//
// This may look like an extremely verbose mess but I wanted to outline exactly what is going to be
// needed to get a working MSI.
//
// ## Tables
//
...
// INSERT INTO `AdvtExecuteSequence` (`Action`, `Sequence`) VALUES ('CreateShortcuts', 4500)
...
// INSERT INTO `Component` (`Component`, `ComponentId`, `Directory_`, `Attributes`, `KeyPath`) VALUES ('6', '{A8A7366E-5D64-54C1-9C59-03E36DB118DD}', '3', 256, '7')
// INSERT INTO `Component` (`Component`, `ComponentId`, `Directory_`, `Attributes`, `KeyPath`) VALUES ('0', '{562E2D89-E877-5B62-AA1B-D16F319A1EA7}', 'DesktopFolder', 260, 'reg8B8E36E486B293215DD585990A46A8CE')
// INSERT INTO `Component` (`Component`, `ComponentId`, `Directory_`, `Attributes`, `KeyPath`) VALUES ('10', '{79D06F27-8B3F-5731-A8AF-D4B734DE70CC}', '5', 256, '11')
// INSERT INTO `Component` (`Component`, `ComponentId`, `Directory_`, `Attributes`, `KeyPath`) VALUES ('13', '{493285EE-0C0C-5551-9B96-9F6AA0D115E5}', '4', 256, '14')
...
// INSERT INTO `Directory` (`Directory`, `Directory_Parent`, `DefaultDir`) VALUES ('DesktopFolder', 'TARGETDIR', 'Desktop')
// INSERT INTO `Directory` (`Directory`, `Directory_Parent`, `DefaultDir`) VALUES ('INSTALLDIR', 'manny', 'PING')
// INSERT INTO `Directory` (`Directory`, `DefaultDir`) VALUES ('TARGETDIR', 'SourceDir')
// INSERT INTO `Directory` (`Directory`, `Directory_Parent`, `DefaultDir`) VALUES ('3', 'INSTALLDIR', 'bin')
// INSERT INTO `Directory` (`Directory`, `Directory_Parent`, `DefaultDir`) VALUES ('5', '4', 'config')
// INSERT INTO `Directory` (`Directory`, `Directory_Parent`, `DefaultDir`) VALUES ('4', 'INSTALLDIR', 'data')
// INSERT INTO `Directory` (`Directory`, `Directory_Parent`, `DefaultDir`) VALUES ('manny', 'ProgramFiles64Folder', 'manny')
// INSERT INTO `Directory` (`Directory`, `Directory_Parent`, `DefaultDir`) VALUES ('ProgramFiles64Folder', 'TARGETDIR', 'PFiles')
...
// NOTE: In my ignorance when first making the original script I made every component it's own
// feature.
//
...
// INSERT INTO `Feature` (`Feature`, `Display`, `Level`, `Attributes`) VALUES ('2', 2, 1, 0)
// INSERT INTO `Feature` (`Feature`, `Display`, `Level`, `Attributes`) VALUES ('8', 2, 1, 0)
// INSERT INTO `Feature` (`Feature`, `Display`, `Level`, `Attributes`) VALUES ('12', 2, 1, 0)
// INSERT INTO `Feature` (`Feature`, `Display`, `Level`, `Attributes`) VALUES ('15', 2, 1, 0)
...
// INSERT INTO `FeatureComponents` (`Feature_`, `Component_`) VALUES ('2', '0')
// INSERT INTO `FeatureComponents` (`Feature_`, `Component_`) VALUES ('8', '6')
// INSERT INTO `FeatureComponents` (`Feature_`, `Component_`) VALUES ('12', '10')
// INSERT INTO `FeatureComponents` (`Feature_`, `Component_`) VALUES ('15', '13')
...
// INSERT INTO `File` (`File`, `Component_`, `FileName`, `FileSize`, `Attributes`, `Sequence`) VALUES ('7', '6', 'ping.exe', 5464691, 512, 1)
// INSERT INTO `File` (`File`, `Component_`, `FileName`, `FileSize`, `Attributes`, `Sequence`) VALUES ('11', '10', 'options.conf', 14, 512, 2)
// INSERT INTO `File` (`File`, `Component_`, `FileName`, `FileSize`, `Attributes`, `Sequence`) VALUES ('14', '13', 'icon.ico', 67646, 512, 3)
...
// INSERT INTO `Icon` (`Name`, `Data`) VALUES ('1', '')
...
// INSERT INTO `InstallExecuteSequence` (`Action`, `Condition`, `Sequence`) VALUES ('StopServices', 'VersionNT', 1900)
// INSERT INTO `InstallExecuteSequence` (`Action`, `Condition`, `Sequence`) VALUES ('DeleteServices', 'VersionNT', 2000)
// INSERT INTO `InstallExecuteSequence` (`Action`, `Sequence`) VALUES ('RemoveRegistryValues', 2600)
// INSERT INTO `InstallExecuteSequence` (`Action`, `Sequence`) VALUES ('RemoveShortcuts', 3200)
// INSERT INTO `InstallExecuteSequence` (`Action`, `Sequence`) VALUES ('RemoveFiles', 3500)
// INSERT INTO `InstallExecuteSequence` (`Action`, `Sequence`) VALUES ('InstallFiles', 4000)
// INSERT INTO `InstallExecuteSequence` (`Action`, `Sequence`) VALUES ('CreateShortcuts', 4500)
// INSERT INTO `InstallExecuteSequence` (`Action`, `Sequence`) VALUES ('WriteRegistryValues', 5000)
// INSERT INTO `InstallExecuteSequence` (`Action`, `Condition`, `Sequence`) VALUES ('InstallServices', 'VersionNT', 5800)
// INSERT INTO `InstallExecuteSequence` (`Action`, `Condition`, `Sequence`) VALUES ('StartServices', 'VersionNT', 5900)
...
// INSERT INTO `Media` (`DiskId`, `LastSequence`, `DiskPrompt`, `Cabinet`) VALUES (1, 3, 'CD-ROM #1', '#PING.cab')
...
// INSERT INTO `MsiFileHash` (`File_`, `Options`, `HashPart1`, `HashPart2`, `HashPart3`, `HashPart4`) VALUES ('7', 0, -486793845, -1978109702, -1585535730, 508107097)
// INSERT INTO `MsiFileHash` (`File_`, `Options`, `HashPart1`, `HashPart2`, `HashPart3`, `HashPart4`) VALUES ('11', 0, 68558604, 539115277, 2048134204, -872244547)
// INSERT INTO `MsiFileHash` (`File_`, `Options`, `HashPart1`, `HashPart2`, `HashPart3`, `HashPart4`) VALUES ('14', 0, -139036463, 1225729016, -1423872358, 501321119)
...
// INSERT INTO `Property` (`Property`, `Value`) VALUES ('DiskPrompt', 'PING Installation [1]')
// INSERT INTO `Property` (`Property`, `Value`) VALUES ('UpgradeCode', '{*}')
// INSERT INTO `Property` (`Property`, `Value`) VALUES ('ALLUSERS', '1')
// INSERT INTO `Property` (`Property`, `Value`) VALUES ('Manufacturer', 'Manny')
// INSERT INTO `Property` (`Property`, `Value`) VALUES ('ProductLanguage', '1033')
// INSERT INTO `Property` (`Property`, `Value`) VALUES ('ProductCode', '{328FDEA1-B4AF-4461-91A9-60F0B3C63DB5}')
// INSERT INTO `Property` (`Property`, `Value`) VALUES ('ProductName', 'PING')
// INSERT INTO `Property` (`Property`, `Value`) VALUES ('ProductVersion', '0.1.0')
...
// CREATE TABLE `Registry` (`Registry` CHAR(72) NOT NULL, `Root` INT NOT NULL, `Key` CHAR(255) NOT NULL LOCALIZABLE, `Name` CHAR(255) LOCALIZABLE, `Value` CHAR(0) LOCALIZABLE, `Component_` CHAR(72) NOT NULL PRIMARY KEY `Registry`)
// INSERT INTO `Registry` (`Registry`, `Root`, `Key`, `Name`, `Value`, `Component_`) VALUES ('reg8B8E36E486B293215DD585990A46A8CE', 1, 'Software\\manny\\ping.exe', 'installed', '#1', '0')
...
// CREATE TABLE `ServiceControl` (`ServiceControl` CHAR(72) NOT NULL, `Name` CHAR(255) NOT NULL LOCALIZABLE, `Event` INT NOT NULL, `Arguments` CHAR(255) LOCALIZABLE, `Wait` INT, `Component_` CHAR(72) NOT NULL PRIMARY KEY `ServiceControl`)
// INSERT INTO `ServiceControl` (`ServiceControl`, `Name`, `Event`, `Wait`, `Component_`) VALUES ('9', 'PingService', 163, 1, '6')
...
// INSERT INTO `ServiceInstall` (`ServiceInstall`, `Name`, `DisplayName`, `ServiceType`, `StartType`, `ErrorControl`, `StartName`, `Component_`, `Description`) VALUES ('9', 'PingService', 'PingService', 16, 2, 1, 'LocalSystem', '6', 'Description for PingService')
...
// INSERT INTO `Shortcut` (`Shortcut`, `Directory_`, `Name`, `Component_`, `Target`, `Description`, `Icon_`, `IconIndex`, `WkDir`) VALUES ('ApplicationDesktopShortcut', 'DesktopFolder', 'PingShortcut', '0', '[INSTALLDIR]bin/ping.exe', 'Run Ping', '1', 0, 'INSTALLDIR')
