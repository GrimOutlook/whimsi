...
fn test_config_output() {
    ...
    let mut verification_command = Command::new("msiinfo");
    let command =
        verification_command.args(["export", "-s", output_path, "Directory"]);
...
",
    ...
    let mut verification_command = Command::new("msiinfo");
    let command =
        verification_command.args(["export", "-s", output_path, "File"]);
    command.assert().stdout( "\
...
",
    ...
    let mut verification_command = Command::new("msiinfo");
    let command =
        verification_command.args(["export", "-s", output_path, "Shortcut"]);
    command.assert().stdout( "\
...
",
    ...
    let mut verification_command = Command::new("msiinfo");
    let command = verification_command.args([
        "export",
        "-s",
        output_path,
        "ServiceInstall",
...
",
    ...
    let mut verification_command = Command::new("msiinfo");
    let command = verification_command.args(["streams", output_path]);
    command.assert().stdout(
        "\
_CABINET_0
Icon._ICON_0
...
",
    ...
    let mut verification_command = Command::new("msiinfo");
    let command =
        verification_command.args(["export", "-s", output_path, "Feature"]);
    command.assert().stdout(
        "\
...
",
    ...
    let mut verification_command = Command::new("msiinfo");
    let command =
        verification_command.args(["export", "-s", output_path, "Component"]);
    command.assert().stdout(
        "\
...
",
    ...
    let mut verification_command = Command::new("msiinfo");
    let command =
        verification_command.args(["export", "-s", output_path, "MsiFileHash"]);
    command.assert().stdout(
        "\
...
",
    ...
    let mut verification_command = Command::new("msiinfo");
    let command =
        verification_command.args(["export", "-s", output_path, "Icon"]);
    command.assert().stdout(
        "\
