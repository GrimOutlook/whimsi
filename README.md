...
- [Installation Error Reference](https://learn.microsoft.com/en-us/windows/win32/msi/windows-installer-error-messages)
Information on error codes seen during installation.
